  ...
  <?php 
   ...
   <div class="x_panel">
      ...
      <div class="x_content">
         ...
         <form action="<?php echo BASE_URL ?>admin/up_custom/<?php echo $st['mand'] ?>" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
          <div class="form-group">
            ...
            <div class="form-group">
               <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <a href="<?php echo BASE_URL ?>admin/list_custom" title=""><button class="btn btn-primary" type="button">Hủy bỏ</button></a>
                  <button class="btn btn-primary" type="reset">Làm mới</button>
                  <button type="submit" class="btn btn-success">Cập nhật</button>
               </div>
            </div>
            <input type="hidden" name="idnv" value="<?php echo $st['makh'] ?>">
         </form>
         <?php 
          }
          ?>
