                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                            $i = 0;
                              foreach ($custom as $key => $st) {
                                $i++;
                             ?>
                        <tr>
                          <td><?php echo $i ?></td>
                          <td><a title="Chỉnh sửa/ xem nội dung" class="hv" href="<?php echo BASE_URL ?>admin/custom_details/<?php echo $st['makh'] ?>"><?php echo $st['tai_khoan_kh'] ?></a></td>
                          ...
                          <td><a href="<?php echo BASE_URL ?>admin/delete_custom/<?php echo $st['makh'] ?>"><center><button class="btn btn-round btn-danger">Xóa</button></center></a></td>
                        </tr>
                        <?php 
                            }
                         ?>
